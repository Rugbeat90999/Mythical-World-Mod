...
@OnlyIn(Dist.CLIENT)
public class AffinityGUI1GuiWindow extends ContainerScreen<AffinityGUI1Gui.GuiContainerMod> {
	private World world;
	private int x, y, z;
	private PlayerEntity entity;
	private final static HashMap guistate = AffinityGUI1Gui.guistate;

	public AffinityGUI1GuiWindow(AffinityGUI1Gui.GuiContainerMod container, PlayerInventory inventory, ITextComponent text) {
	...
	public void init(Minecraft minecraft, int width, int height) {
		...
		this.addButton(new Button(this.guiLeft + 55, this.guiTop + 47, 30, 20, new StringTextComponent("+"), e -> {
			if (true) {
				MythicalWorldMod.PACKET_HANDLER.sendToServer(new AffinityGUI1Gui.ButtonPressedMessage(0, x, y, z));
				AffinityGUI1Gui.handleButtonAction(entity, 0, x, y, z);
			}
		}));
		this.addButton(new Button(this.guiLeft + 6, this.guiTop + 47, 30, 20, new StringTextComponent("-"), e -> {
			if (true) {
				MythicalWorldMod.PACKET_HANDLER.sendToServer(new AffinityGUI1Gui.ButtonPressedMessage(1, x, y, z));
				AffinityGUI1Gui.handleButtonAction(entity, 1, x, y, z);
			}
		}));
		this.addButton(new Button(this.guiLeft + 55, this.guiTop + 81, 30, 20, new StringTextComponent("+"), e -> {
			if (true) {
				MythicalWorldMod.PACKET_HANDLER.sendToServer(new AffinityGUI1Gui.ButtonPressedMessage(2, x, y, z));
				AffinityGUI1Gui.handleButtonAction(entity, 2, x, y, z);
			}
		}));
		this.addButton(new Button(this.guiLeft + 6, this.guiTop + 81, 30, 20, new StringTextComponent("-"), e -> {
			if (true) {
				MythicalWorldMod.PACKET_HANDLER.sendToServer(new AffinityGUI1Gui.ButtonPressedMessage(3, x, y, z));
				AffinityGUI1Gui.handleButtonAction(entity, 3, x, y, z);
			}
		}));
		this.addButton(new Button(this.guiLeft + 55, this.guiTop + 115, 30, 20, new StringTextComponent("+"), e -> {
			if (true) {
				MythicalWorldMod.PACKET_HANDLER.sendToServer(new AffinityGUI1Gui.ButtonPressedMessage(4, x, y, z));
				AffinityGUI1Gui.handleButtonAction(entity, 4, x, y, z);
			}
		}));
		this.addButton(new Button(this.guiLeft + 6, this.guiTop + 115, 30, 20, new StringTextComponent("-"), e -> {
			if (true) {
				MythicalWorldMod.PACKET_HANDLER.sendToServer(new AffinityGUI1Gui.ButtonPressedMessage(5, x, y, z));
				AffinityGUI1Gui.handleButtonAction(entity, 5, x, y, z);
			}
		}));
		this.addButton(new Button(this.guiLeft + 138, this.guiTop + 47, 30, 20, new StringTextComponent("+"), e -> {
			if (true) {
				MythicalWorldMod.PACKET_HANDLER.sendToServer(new AffinityGUI1Gui.ButtonPressedMessage(6, x, y, z));
				AffinityGUI1Gui.handleButtonAction(entity, 6, x, y, z);
			}
		}));
		this.addButton(new Button(this.guiLeft + 89, this.guiTop + 47, 30, 20, new StringTextComponent("-"), e -> {
			if (true) {
				MythicalWorldMod.PACKET_HANDLER.sendToServer(new AffinityGUI1Gui.ButtonPressedMessage(7, x, y, z));
				AffinityGUI1Gui.handleButtonAction(entity, 7, x, y, z);
			}
		}));
		this.addButton(new Button(this.guiLeft + 138, this.guiTop + 81, 30, 20, new StringTextComponent("+"), e -> {
			if (true) {
				MythicalWorldMod.PACKET_HANDLER.sendToServer(new AffinityGUI1Gui.ButtonPressedMessage(8, x, y, z));
				AffinityGUI1Gui.handleButtonAction(entity, 8, x, y, z);
			}
		}));
		this.addButton(new Button(this.guiLeft + 89, this.guiTop + 81, 30, 20, new StringTextComponent("-"), e -> {
			if (true) {
				MythicalWorldMod.PACKET_HANDLER.sendToServer(new AffinityGUI1Gui.ButtonPressedMessage(9, x, y, z));
				AffinityGUI1Gui.handleButtonAction(entity, 9, x, y, z);
			}
		}));
		this.addButton(new Button(this.guiLeft + 138, this.guiTop + 115, 30, 20, new StringTextComponent("+"), e -> {
			if (true) {
				MythicalWorldMod.PACKET_HANDLER.sendToServer(new AffinityGUI1Gui.ButtonPressedMessage(10, x, y, z));
				AffinityGUI1Gui.handleButtonAction(entity, 10, x, y, z);
			}
		}));
		this.addButton(new Button(this.guiLeft + 89, this.guiTop + 115, 30, 20, new StringTextComponent("-"), e -> {
			if (true) {
				MythicalWorldMod.PACKET_HANDLER.sendToServer(new AffinityGUI1Gui.ButtonPressedMessage(11, x, y, z));
				AffinityGUI1Gui.handleButtonAction(entity, 11, x, y, z);
			}
		}));
		this.addButton(new Button(this.guiLeft + 64, this.guiTop + 139, 46, 20, new StringTextComponent("Next"), e -> {
			if (true) {
				MythicalWorldMod.PACKET_HANDLER.sendToServer(new AffinityGUI1Gui.ButtonPressedMessage(12, x, y, z));
				AffinityGUI1Gui.handleButtonAction(entity, 12, x, y, z);
			}
		}));
	}
}
